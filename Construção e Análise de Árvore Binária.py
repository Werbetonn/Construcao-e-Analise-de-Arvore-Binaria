...
print("Quantidade de folhas na árvore:", qtd_folhas)
buscarNum = int(input("Qual número deseja procurar: "))
no_encontrado = arvore.busca(buscarNum)

if no_encontrado is not None:
    print(f"O nó {buscarNum} foi encontrado na árvore.")
else:
    print(f"O nó {buscarNum} foi não encontrado na árvore.")